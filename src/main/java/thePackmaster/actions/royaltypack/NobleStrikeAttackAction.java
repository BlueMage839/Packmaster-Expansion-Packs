...
//Yes, it's a copy of a decompiled version of GreedVersion, but with a
// diagonal slash fx effect instead of a blunt attack.
public class NobleStrikeAttackAction extends AbstractGameAction {
    private int increaseGold;
    private DamageInfo info;
    private static final float DURATION = 0.1F;

    public NobleStrikeAttackAction(AbstractCreature target, DamageInfo info, int goldAmount) {
        this.info = info;
